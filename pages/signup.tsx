...
export default function Signup() {
  ...
  return (
    <>
      <SEO
        title="Sign Up — RatingE"
        description="Create your free RatingE account. Start managing reviews and growing your online reputation today."
        canonical="https://ratinge.com/signup"
      />
      <div style={{ background: BG, color: TEXT, fontFamily: "system-ui, -apple-system, sans-serif", minHeight: "100vh" }}>
        ...
        <section style={{ padding: isMobile ? "60px 20px" : "96px 24px", maxWidth: 480, margin: "0 auto" }}>
          <div style={{ background: CARD, borderRadius: 16, padding: isMobile ? 28 : 40, border: "1px solid rgba(255,255,255,0.06)" }}>
            <h1 style={{ fontSize: 28, fontWeight: 800, marginBottom: 8, textAlign: "center" }}>Start Free Trial</h1>
            <p style={{ color: MUTED, textAlign: "center", marginBottom: 32, fontSize: 15 }}>
              Create your RatingE account — no credit card required
            </p>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 20 }}>
                <label style={{ display: "block", fontSize: 14, fontWeight: 600, marginBottom: 8, color: MUTED }}>Full Name</label>
                <input
            ...
            <p style={{ textAlign: "center", marginTop: 24, color: MUTED, fontSize: 14 }}>
              ...
              <Link href="/login" style={{ color: PRIMARY, textDecoration: "none", fontWeight: 600 }}>Log In</Link>
            </p>
          </div>
        </section>
